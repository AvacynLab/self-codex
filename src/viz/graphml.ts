...
export interface GraphMlRenderOptions {
  /** Optional attribute exposed as the human readable node label. */
  labelAttribute?: string;
  /** Attribute forwarded to edges as a numeric weight. */
 ...
 */
export function renderGraphmlFromGraph(
  descriptor: GraphDescriptorPayload,
  options: GraphMlRenderOptions = {},
): string {
