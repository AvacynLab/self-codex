...
/**
 * Runtime representation of the reflection input accepted by {@link reflect}.
 */
export type ReflectionInput = z.infer<typeof ReflectionInputSchema>;

/**
 * Structured response produced by the reflection module.
 */
export interface ReflectionResult {
  /** Key learnings or observations from the deliverable. */
  insights: string[];
 ...
 */
function normaliseToText(value: unknown): string {
 ...
 */
function truncateList(values: Set<string>, limit: number): string[] {
 ...
 */
export async function reflect(raw: ReflectionInput): Promise<ReflectionResult> {
