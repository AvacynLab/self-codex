...
import { DijkstraResult, EdgeCostDescriptor, EdgeCostEvaluator, buildEdgeCostEvaluator, shortestPath } from "./dijkstra.js";

export interface KShortestPathOptions {
  readonly weightAttribute?: string;
  readonly costFunction?: EdgeCostEvaluator | EdgeCostDescriptor | string;
  readonly maxDeviation?: number;
}

export interface KShortestPathResult extends DijkstraResult {}
...
export function kShortestPaths(
  ...
  const results: KShortestPathResult[] = [initial];
