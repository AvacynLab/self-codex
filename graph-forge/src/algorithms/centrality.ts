...
import { buildEdgeCostEvaluator, DijkstraOptions, EdgeCostDescriptor, EdgeCostEvaluator } from "./dijkstra.js";
...
export interface CentralityOptions extends DijkstraOptions {
 ...
 */
export function degreeCentrality(graph: GraphModel): DegreeCentralityResult[] {
 ...
 */
export function closenessCentrality(graph: GraphModel, options: CentralityOptions = {}): ClosenessCentralityResult[] {
