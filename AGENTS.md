...
- 2025-10-10 – Agent `gpt-5-codex` (iteration 102) — Vérification de l’exposition des outils MCP via HTTP en ajoutant le test e2e `http.tools.discovery` (liste + appel `mcp_info`) et exécution complète de la suite (`npm test`).
